              ...
              {navLinks.map((link, i) => {
                ...
                return (
                  ...
                  >
                    {link.name}
                    <span
                      className={`absolute bottom-0 left-4 right-4 h-[2px] bg-[#c8f135] transition-transform duration-300 origin-left rounded-full ${
                        active
                          ? "scale-x-100"
                  ...
                  {contactInfo.map(
                    ({ icon: Icon, text }, i) => (
                      ...
                      >
                        ...
                        <span className="text-white/70 text-[14px] leading-snug pt-1">
                          {text}
                        </span>
                      </motion.li>
                    ),
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            <motion.a
              ...
              onClick={() => setIsMobileMenuOpen(false)}
              className="mt-4 px-8 py-3 rounded-md bg-[#c8f135] text-[#0b1940] font-black text-sm tracking-widest"
            >
              GET IN TOUCH
            </motion.a>
          </motion.div>
