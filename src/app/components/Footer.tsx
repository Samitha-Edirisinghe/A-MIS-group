              ...
              <div className="space-y-3">
                {[
                  ...
                  <motion.a
                    key={label}
                    href={href}
                    className="flex items-center gap-3 text-white/60 hover:text-[#c8f135] transition-colors group"
                    whileHover={{ x: 4 }}
                  >
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-white/50 hover:text-white transition-all duration-200 inline-flex items-center gap-2.5 group text-sm"
                  >
