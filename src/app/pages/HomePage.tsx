...
const projects = [
  { title: "Dan TV", cat: "Web Design", url: "https://www.dantv.lk/", image: "https://images.unsplash.com/photo-1742805382149-3c2f0cd0f300?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" },
  { title: "Lion Isle Travels", cat: "Travel & Tourism", url: "https://www.lionisle.com/", image: "https://images.unsplash.com/photo-1589779677460-a15b5b5790ce?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" },
  { title: "Menaric Wedding", cat: "Photography & Video", url: "https://photography-and-videography-service.vercel.app/", image: "https://images.unsplash.com/photo-1519741196428-6a2175fa2557?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800" },
];
          ...
          <div className="max-w-xl lg:max-w-2xl">
            ...
            <motion.div key={`cta-${animKey}`} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
              ...
              <a href={slide.cta.href}
                className="inline-flex items-center gap-2 px-6 py-3 font-black text-sm rounded-lg hover:brightness-110 active:brightness-90 active:scale-95 transition-all duration-200"
              ...
              <a href="#/contact"
                className="inline-flex items-center gap-2 px-6 py-3 border border-white/20 text-white font-bold text-sm rounded-lg hover:border-white/50 active:border-white/50 hover:bg-white/5 active:bg-white/10 active:scale-95 transition-all duration-200">
      ...
      <div className="relative z-20 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-16">
          <div className="grid grid-cols-2 md:grid-cols-4">
            {stats.map((s, i) => (
              <div key={s.label}
                className={`group py-7 px-8 flex items-center gap-5 relative transition-colors duration-200 hover:bg-white/[0.03] active:bg-white/[0.06] ${
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="mb-16">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
              ...
              <a href="#/services" className="inline-flex items-center gap-2 text-sm font-bold text-[#0b1940] hover:text-[#c8f135] active:text-[#c8f135] transition-colors duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {studios.map((studio, i) => (
              <motion.a
                ...
                className="group card-lift flex flex-col rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl active:shadow-xl hover:border-transparent active:border-transparent transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              <a href="#/about" className="inline-flex items-center gap-2 px-7 py-4 bg-[#0b1940] text-white font-bold text-sm rounded hover:bg-[#0d2050] active:bg-[#0d2050] active:scale-95 transition-all duration-200">
      ...
      <section className="py-28 px-6 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <a href="#/portfolio" className="inline-flex items-center gap-2 text-sm font-bold text-[#0b1940] hover:text-[#c8f135] active:text-[#c8f135] transition-colors duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {projects.map((p, i) => (
              <motion.a key={p.title} href={(p as any).url} target="_blank" rel="noopener noreferrer"
                initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }}
                className="group card-lift cursor-pointer rounded-2xl overflow-hidden border border-gray-100 hover:shadow-xl active:shadow-xl hover:border-[#c8f135]/30 active:border-[#c8f135]/30 transition-all duration-300">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-[#0b1940]/0 group-hover:bg-[#0b1940]/60 transition-colors duration-300 flex items-center justify-center">
                    <span className="text-white font-bold text-sm opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-2">Visit Site <ArrowUpRight className="w-4 h-4" /></span>
                  </div>
                </div>
                <div className="p-5">
      ...
      <section className="py-20 px-6 lg:px-16 bg-[#c8f135]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a href="#/contact" className="shrink-0 inline-flex items-center gap-2 px-8 py-4 bg-[#0b1940] text-white font-black text-sm rounded hover:bg-[#0d2050] active:bg-[#0d2050] active:scale-95 transition-all duration-200">
