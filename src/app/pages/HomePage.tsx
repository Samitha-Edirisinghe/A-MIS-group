...
const projects = [
  { title: "Dan TV", cat: "Web Design", url: "https://www.dantv.lk/", image: _imgs["/assets/dan-tv.jpg"] },
  { title: "Lion Isle Travels", cat: "Travel & Tourism", url: "https://www.lionisle.com/", image: _imgs["/assets/lion-isle.jpg"] },
  { title: "Menaric Wedding", cat: "Photography & Video", url: "https://photography-and-videography-service.vercel.app/", image: _imgs["/assets/menaric-wedding.jpg"] },
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }} className="relative">
              <div className="rounded-2xl overflow-hidden">
                <img src={_imgs["/assets/about-team.jpg"]} alt="A'MIS team" className="w-full h-[480px] object-cover" />
              </div>
