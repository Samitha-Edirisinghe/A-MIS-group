...
const services = [
  {
    ...
    image: "https://images.unsplash.com/photo-1552168324-d612d77725e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1615160460367-dcccd27e11ad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1587090564077-c7b8f2f1249e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
  ...
  },
  {
    icon: Aperture,
    title: "Aerial & Drone",
    image: "https://images.unsplash.com/photo-1591892212776-a09de24dbe84?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=800",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col" style={{ background: '#0a1535' }}>
        ...
        <div className="md:hidden absolute inset-0 z-0">
          <img src="https://images.unsplash.com/photo-1552168324-d612d77725e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400" alt="" className="w-full h-full object-cover" />
        ...
        >
          <img src="https://images.unsplash.com/photo-1552168324-d612d77725e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1400" alt="Captura photography" className="w-full h-full object-cover" />
        ...
        <div
          ...
          style={{ fontSize: 'clamp(8rem, 22vw, 22rem)', color: 'rgba(56,189,248,0.04)', letterSpacing: '-0.05em' }}
        >02</div>
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-16 w-full py-12 md:py-16">
          ...
          >
            ...
            >
              A'MIS<br />
              <span style={{ color: ACCENT, textShadow: `0 0 80px ${ACCENT}45` }}>Captura</span>
            </h1>
      ...
      <section className="relative h-52 md:h-80 overflow-hidden">
        <img
          src="https://images.unsplash.com/photo-1612548403247-aa2873e9422d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1600"
          alt="Captura studio"
