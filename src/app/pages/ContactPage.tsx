...
import { ArrowUpRight, Mail, Phone, MapPin, Clock, Send, ChevronDown } from "lucide-react";
import { PageNav } from "../components/PageNav";
import { Footer } from "../components/Footer";

const studios = [
  { name: "A'MIS Creotech", accent: "#c8f135", tagline: "Technology & Creative", email: "creotech@amisgroups.com", phone: "0762688365", phoneDisplay: "076 268 8365" },
...
const info = [
  ...
  { icon: Phone,   label: "Call Us",     value: "077 003 1808" },
      ...
      <section className="relative min-h-[90vh] overflow-hidden pt-16 flex flex-col">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1624555130581-1d9cca783bc0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1600"
            alt="Contact A'MIS Group" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-16 py-16 md:py-28 w-full">
          <motion.div initial={{ opacity: 0, y: 36 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }} className="max-w-2xl">
            <div className="flex items-center gap-3 mb-6 md:mb-8">
              ...
              <span className="text-xs font-bold tracking-[0.28em] text-[#c8f135] uppercase">Get In Touch</span>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <a href="#contact-form" className="inline-flex items-center gap-2 px-8 py-4 bg-[#c8f135] text-[#0b1940] font-black text-sm rounded hover:bg-[#d5f84a] transition-colors">
                Send a Message <ArrowUpRight className="w-4 h-4" />
              </a>
              <a href="tel:0770031808" className="inline-flex items-center gap-2 px-8 py-4 border border-white/25 text-white font-bold text-sm rounded hover:border-white/60 transition-colors">
                Call: 077 003 1808
              </a>
            </div>
          </motion.div>
