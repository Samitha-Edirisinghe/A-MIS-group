...
const studios = [
  ...
  { name: "A'MIS Cinemix",  accent: "#a78bfa", tagline: "Video Production",      email: "cinemix@amisgroups.com",  phone: "0765800738", phoneDisplay: "076 5800 738" },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-[#0b1940] overflow-hidden flex flex-col" style={{ minHeight: "100vh" }}>
        ...
        <div className="absolute inset-0">
          <img src={_imgs["/assets/contact-hero.jpg"]}
