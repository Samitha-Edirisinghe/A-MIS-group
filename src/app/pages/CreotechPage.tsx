...
import {
  ...
  PenTool, TrendingUp, ArrowUpRight, CheckCircle2,
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col" style={{ background: '#0a1535' }}>
        ...
        <div
          ...
          style={{ fontSize: 'clamp(8rem, 22vw, 22rem)', color: 'rgba(200,241,53,0.04)', letterSpacing: '-0.05em' }}
        >01</div>
        ...
        <div className="relative z-20 flex-1 flex flex-col justify-center max-w-7xl mx-auto px-6 lg:px-16 w-full py-12 md:py-16">
          ...
          >
            ...
            >
              A'MIS<br />
              <span style={{ color: ACCENT, textShadow: `0 0 80px ${ACCENT}45` }}>Creotech</span>
            </h1>
