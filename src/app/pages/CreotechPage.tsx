...
const services = [
  {
    ...
    image: _imgs["/assets/creotech-hero.jpg"],
  ...
  },
  {
    ...
    image: _imgs["/assets/creotech-3.jpg"],
  ...
  },
  {
    ...
    image: _imgs["/assets/creotech-1.jpg"],
  ...
  },
  {
    icon: Palette,
    title: "UI/UX Design",
    image: _imgs["/assets/creotech-4.jpg"],
  ...
  },
  {
    ...
    image: _imgs["/assets/creotech-2.jpg"],
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen overflow-hidden flex flex-col" style={{ background: '#0a1535' }}>
        ...
        <div className="md:hidden absolute inset-0 z-0">
          <img src={_imgs["/assets/creotech-hero.jpg"]} alt="" className="w-full h-full object-cover" />
        ...
        <div className="hidden md:block absolute top-0 right-0 bottom-0 w-[54%] z-0"
          ...
          <img src={_imgs["/assets/creotech-hero.jpg"]} alt="Creotech workspace" className="w-full h-full object-cover" />
      ...
      <section className="relative h-52 md:h-80 overflow-hidden">
        <img
          src={_imgs["/assets/creotech-hero.jpg"]}
