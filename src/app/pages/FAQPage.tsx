...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Our main office is located at Main Street, Melbourne, Australia. We serve clients globally and can work remotely or on-site depending on project requirements."
  },
  {
    category: "Services",
          ...
          >
            ...
            <div className="max-w-2xl mx-auto relative">
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/20 rounded-2xl pl-14 pr-6 py-5 text-white placeholder:text-white/40 focus:outline-none focus:border-[#c8f135] transition-colors backdrop-blur-xl"
              />
            </div>
          </motion.div>
        </div>
